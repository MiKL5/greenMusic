 ...
 */
class getCategiryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategiryRepository' shared autowired service.
     *
     * @return \App\Repository\CategiryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategiryRepository.php';

        return $container->privates['App\\Repository\\CategiryRepository'] = new \App\Repository\CategiryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
